...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/vitorvavolizza/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/vitorvavolizza/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/vitorvavolizza/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/vitorvavolizza/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/vitorvavolizza/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/vitorvavolizza/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ----------------------- |
| `pg_normalized`        | 3m36.331s                 | 0m17.59s                |
| `pg_normalized_batch`  | 3m3.300s                  | 0m16.76s                |
| `pg_denormalized`      | 0m17.048s                 | 0m03.92s                |
